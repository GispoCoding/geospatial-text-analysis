...
### *[Click here to download the result Geopackage.|Tästä linkistä voit ladata kokeilun tulokset QGIS-Geopackagena!](https://github.com/GispoCoding/geospatial-text-analysis/raw/main/qgis_project_and_layers.gpkg)*
